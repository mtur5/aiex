...
# 被験者の入力１
st.write("#### AIの協力を得て研究仮説を立てて行きましょう。先行研究で、面白いと思った言葉や内容について、簡単に記入してください。（研究者名、論文題名があると良いです）")
...
私が面白いと思った言葉から、私が考えているのは、{hypothesis} という仮説です。この仮説から、論文が書けると考えています。この仮説に関連する先行研究から、あなたが、私の指導教員の立場として、私の仮説を前向きに捉え、新規性を示すと共に、批判的な意見を分かりやすく示していただけると嬉しいです。"""}
            ]
        )
...
が、仮説を立てる際に気になっているので、このことについて教えて下さい。私の仮説の強みと批判的な検討内容を分かりやすく簡単に示して下さい。"""}
            ]
        )
...
# 被験者の入力３
st.write("#### AIの回答から仮説の深掘りの役に立ちそうなポイントを引用して書いて下さい。AIから、あなたの仮説・推論を深堀りする方法について提案があります。記入したら、青いボタンを押して下さい。")
...
が、参考になりました。それでは、私が次の推論をして仮説を深堀りできるように分かりやすく作業手順の例を具体的に示して下さい。私の仮説・推論に役立つ論文を３つ紹介して下さい。"""}
            ]
        )
        ai_response_3 = response.choices[0].message.content
        st.session_state["ai_response_3"] = ai_response_3
        st.success("AIから、あなたの仮説を深堀りするための提案です！")
