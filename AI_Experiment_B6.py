...
# 被験者の入力１
st.write("#### あなたが学会に論文を投稿するために、仮説を記入しましょう。記入したら、「AIに仮説を立てる協力をしてもらう」青いボタンを押して下さい。")
...
学会に論文を投稿するために仮説を立てています。私が考えているのは、{hypothesis} という仮説です。"""}
            ]
        )
...
# 被験者の入力２
st.write("#### AIからの提案で気になった内容、AIに仮説を立てるための疑問点、深堀りしたいことを聞きましょう。記入したら、「AIに仮説を立てる協力をしてもらう」青いボタンを押して下さい。")
...
# 被験者の入力３
st.write("#### AIの回答から仮説の深掘りの役に立ちそうなポイントを引用して書いて下さい。記入したら、「AIに仮説を立てる協力をしてもらう」青いボタンを押して下さい。")
...
それでは、仮説を深堀りできるように作業手順の例を具体的に示して下さい。"""}
            ]
        )
...
st.write("終わったら「実験Bの結果を保存して終了」青いボタンを押して下さい。")
